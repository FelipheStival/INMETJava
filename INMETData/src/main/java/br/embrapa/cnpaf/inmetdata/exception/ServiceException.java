 ...
 * <br>
 * <p>
 * <b> Error occurred during initialization of system services.</b>
 * </p>
 * 
...
public class ServiceException extends GenericException {
	 ...
	 */
	public ServiceException(GenericException exception) {
		super(exception);
	}
	 ...
	 */
	public ServiceException(String message, String ipAddress, MessageEnum error, String className, String methodName, String exceptionMessage, List<GenericException> causes) {
