...
public class InmetCityDataDAO extends GenericDAO<InmetCityDataDAO, InmetCityEntily> {
	...
	public InmetCityDataDAO save(InmetCityEntily entity) throws PersistenceException {
		...
		// save Relationship
		this.saveStateRelationship(entity.getStateEntily());
...
//			this.removeStationRelationship(station.getId());
	...
	protected InmetCityEntily getEntity(ResultSet queryResult) throws PersistenceException {
		...
		try {
			...
			InmetStateEntily entity = this.getStateRelationship(idState);
	 ...
	 *                              relationship.
	 */
	private InmetCityDataDAO saveStateRelationship(InmetStateEntily entity) throws PersistenceException {
		if (entity != null) {
	 ...
	 *                              relationship.
	 */
	private InmetStateEntily getStateRelationship(Long entityId) throws PersistenceException {
		if (entityId != null) {
	...
	public void startRecords() throws PersistenceException {
		...
		List<InmetCityEntily> stateEntilies = this.list();
		List<String> queries = new ArrayList<String>();

		if (stateEntilies.size() == 0) {
			queries.add("INSERT INTO " + TABLE_INMET_CITY + " (id_state,latitude,longitude,name) VALUES "
					+ "(1,-14.133,-47.5232,'Alto Paraíso'),\r\n" + "(1,-15.9026,-52.2451,'Aragarças'),\r\n"
					+ "(1,-16.9668,-51.8175,'Caiapônia'),\r\n" + "(1,-18.1547,-47.9276,'Catalão'),\r\n"
					+ "(1,-16.7848,-47.6129,'Cristalina'),\r\n" + "(1,-16.3993,-47.6258,'Cristalina'),\r\n"
					+ "(1,-17.337,-49.9147,'Edéia'),\r\n" + "(1,-15.2201,-48.9901,'Goianésia'),\r\n"
					+ "(1,-16.6428,-49.2202,'Goiânia'),\r\n" + "(1,-15.9397,-50.1414,'Goiás'),\r\n"
					+ "(1,-16.423,-51.1488,'Iporá'),\r\n" + "(1,-14.9797,-49.5399,'Itapaci'),\r\n"
					+ "(1,-18.4097,-49.192,'Itumbiara'),\r\n" + "(1,-17.9236,-51.7174,'Jataí'),\r\n"
					+ "(1,-16.2605,-47.9669,'Luziânia'),\r\n" + "(1,-47.4548,-52.6012,'Mineiros'),\r\n"
					+ "(1,-13.2535,-46.8903,'Monte Alegre de Goiás'),\r\n" + "(1,-17.745,-49.1016,'Morrinhos'),\r\n"
					+ "(1,-16.9625,-50.4254,'Paraúna'),\r\n" + "(1,-17.3041,-48.2841,'Pires do Rio'),\r\n"
					+ "(1,-13.3095,-49.1174,'Porangatú'),\r\n" + "(1,-14.0892,-46.3664,'Posse'),\r\n"
					+ "(1,-17.7853,-50.9648,'Rio Verde'),\r\n" + "(1,-12.8204,-50.3359,'São Miguel do Araguaia'),\r\n"
					+ "(1,-18.9691,-50.6334,'São Simão'),\r\n" + "(2,-14.0164,-52.2116,'Água Boa'),\r\n"
					+ "(2,-10.0772,-56.1792,'Alta Floresta'),\r\n" + "(2,-17.3393,-53.2244,'Alto Araguaia'),\r\n"
					+ "(2,-17.841,-53.2894,'Alto Taquari'),\r\n" + "(2,-9.5633,-57.3935,'Apiacás'),\r\n"
					+ "(2,-16.0747,-57.693,'Cáceres'),\r\n" + "(2,-13.7859,-57.8384,'Campo Novo dos Parecis'),\r\n"
					+ "(2,-15.5314,-55.1356,'Campo Verde'),\r\n" + "(2,-9.9705,-55.8275,'Carlinda'),\r\n"
					+ "(2,-13.708,-59.7623,'Comodoro'),\r\n" + "(2,-9.9062,-58.5722,'Cotriguaçú'),\r\n"
					+ "(2,-15.6068,-56.0609,'Cuiabá'),\r\n" + "(2,-13.1848,-53.2573,'Gaucha do Norte'),\r\n"
					+ "(2,-9.9525,-54.8978,'Guaratã do Norte'),\r\n" + "(2,-16.3415,-53.766,'Guiratinga'),\r\n"
					+ "(2,-17.175,-54.5016,'Itiquira'),\r\n" + "(2,-11.2801,-57.5266,'Juara'),\r\n"
					+ "(2,-11.3751,-58.7747,'Juína'),\r\n" + "(2,-13.0386,-57.0922,'Nova Maringá'),\r\n"
					+ "(2,-13.4111,-54.7521,'Nova Ubiratã'),\r\n" + "(2,-12.5219,-58.2314,'Novo Mundo'),\r\n"
					...
					+ "(2,-12.6273,-52.2208,'Querência'),\r\n" + "(2,-16.4624,-54.5801,'Rondonópolis'),\r\n"
					+ "(2,-14.8289,-56.4419,'Rosário Oeste'),\r\n" + "(2,-15.1248,-58.127,'Salto do Céu'),\r\n"
					+ "(2,-14.9278,-53.8836,'Santo Antônio do Leste'),\r\n"
					+ "(2,-11.619,-50.7278,'São Félix do Araguaia'),\r\n"
					+ "(2,-13.4539,-56.6773,'São José do Rio Claro'),\r\n"
					+ "(2,-10.4841,-52.3725,'São José do Xingú'),\r\n" + "(2,-13.304,-58.7635,'Sapezal'),\r\n"
					+ "(2,-11.9879,-51.426,'Serra Nova Dourada'),\r\n" + "(2,-11.9822,-55.5659,'Sinop'),\r\n"
					+ "(2,-12.5551,-55.7228,'Sorriso'),\r\n" + "(2,-14.6501,-57.4315,'Tangará da Serra'),\r\n"
					+ "(2,-15.0626,-59.8729,'Vila Bela da Santíssima Trindade'),\r\n"
					+ "(3,-9.949,-62.9618,'Ariquemes'),\r\n" + "(3,-11.4458,-61.4341,'Cacoal'),\r\n"
					+ "(3,-8.7936,-63.8459,'Porto Velho'),\r\n" + "(3,-12.7348,-60.1577,'Vilhena'),\r\n"
					+ "(4,-11.284,-47.2121,'Almas'),\r\n" + "(4,-12.5922,-49.5287,'Araguaçu'),\r\n"
					+ "(4,-7.1039,-48.2012,'Araguaina'),\r\n" + "(4,-5.6437,-48.1118,'Araguatins'),\r\n"
					+ "(4,-8.1546,-46.6393,'Campos Lindos'),\r\n" + "(4,-8.0927,-48.4786,'Colinas do Tocantins'),\r\n"
					+ "(4,-11.5944,-46.8472,'Dianópolis'),\r\n" + "(4,-11.8873,-49.6082,'Formoso do Araguaia'),\r\n"
					+ "(4,-11.7457,-49.0497,'Gurupi'),\r\n" + "(4,-10.8282,-49.8478,'Lagoa da Confusão'),\r\n"
					+ "(4,-9.5763,-49.7233,'Marianópolis do Tocantis'),\r\n" + "(4,-10.4344,-45.9219,'Mateiros'),\r\n"
					+ "(4,-10.1907,-48.3018,'Palmas'),\r\n" + "(4,-12.6148,-47.8719,'Paranã'),\r\n"
					+ "(4,-8.9686,-48.1772,'Pedro Afonso'),\r\n" + "(4,-12.0153,-48.5445,'Peixe'),\r\n"
					+ "(4,-10.4769,-49.6294,'Pium'),\r\n" + "(4,-9.7933,-47.1327,'Rio Sono'),\r\n"
					+ "(4,-7.1241,-48.7812,'Santa Fé do Araguaia'),\r\n"
					+ "(4,-11.429,-48.1848,'Santa Rosa do Tocantins'),\r\n" + "(5,-3.2702,-52.3948,'Altamira'),\r\n"
					+ "(5,-1.4112,-48.4395,'Belém'),\r\n" + "(5,-1.0472,-46.7857,'Bragança'),\r\n"
					+ "(5,-1.6802,-50.4781,'Breves'),\r\n" + "(5,-2.2396,-49.4998,'Cametá'),\r\n"
					+ "(5,-1.7347,-47.0575,'Capitão Poço'),\r\n" + "(5,-1.3008,-47.9479,'Castanhal'),\r\n"
					+ "(5,-8.3036,-49.2827,'Conceição do Araguaia'),\r\n" + "(5,-4.2805,-47.5639,'Dom Eliseu'),\r\n"
					+ "(5,-4.2769,-55.993,'Itaituba'),\r\n" + "(5,-5.3664,-49.0511,'Marabá'),\r\n"
					+ "(5,-3.5109,-52.9634,'Medicilândia'),\r\n" + "(5,-6.32,-55.7877,'Mina Palito'),\r\n"
					+ "(5,-2,-54.0764,'Monte Alegre'),\r\n" + "(5,-4.2439,-49.9393,'Novo Repartimento'),\r\n"
					+ "(5,-1.8807,-55.5198,'Óbidos'),\r\n" + "(5,-3.8437,-50.638,'Pacajá'),\r\n"
					+ "(5,-2.9903,-47.4078,'Paragominas'),\r\n" + "(5,-3.864,-54.2154,'Placas'),\r\n"
					+ "(5,-1.8221,-52.1117,'Porto de Moz'),\r\n" + "(5,-8.3432,-50.0069,'Redenção'),\r\n"
					+ "(5,-4.8275,48.1735,'Rondon do Pará'),\r\n" + "(5,-0.6188,-47.3565,'Salinópolis'),\r\n"
					+ "(5,-9.3386,-50.3502,'Santana do Araguaia'),\r\n" + "(5,-2.5025,-54.7202,'Santarém'),\r\n"
					+ "(5,-6.6396,-51.9569,'São Félix do Xingú'),\r\n" + "(5,-6.0774,-50.1422,'Serra dos Carajás'),\r\n"
					+ "(5,-0.7278,-48.5157,'Soure'),\r\n" + "(5,-2.5926,-48.3605,'Tomé Açú'),\r\n"
					+ "(5,-6.7432,-51.1418,'Tucumã'),\r\n" + "(5,-3.8227,-49.6749,'Tucuruí'),\r\n"
					+ "(5,-7.1105,-49.926,'Xinguara'),\r\n" + "(6,-9.1081,-45.932,'Alto Parnaíba'),\r\n"
					...
					+ "(6,-6.6532,-47.4182,'Estreito'),\r\n" + "(6,-2.5923,-42.7075,'Farol Preguiças'),\r\n"
					+ "(6,-2.2708,-43.624,'Farol Santana'),\r\n" + "(6,-5.816,-46.1622,'Grajaú'),\r\n"
					+ "(6,-5.5557,-47.4597,'Imperatriz'),\r\n" + "(6,-2.5267,-44.2165,'São Luís'),\r\n"
					+ "(6,-1.6612,-45.3725,'Turiaçú'),\r\n" + "(6,-3.2691,-45.651,'Zé Doca'),\r\n"
					+ "(7,-8.4415,-43.8654,'Alvorada do Gurguéia'),\r\n"
					+ "(7,-6.0894,-42.7273,'Angical do Piauí'),\r\n"
					+ "(7,-8.3335,-45.0946,'Baixa Grande do Ribeira'),\r\n"
					+ "(7,-9.0832,-44.3264,'Bom Jesus do Piauí'),\r\n" + "(7,-4.8641,-42.1455,'Campo Maior'),\r\n"
					+ "(7,-8.1179,-42.9757,'Canto do Buriti'),\r\n" + "(7,-9.2858,-43.3244,'Caracol'),\r\n"
					+ "(7,-5.3492,-41.5122,'Castelo do Piauí'),\r\n" + "(7,-10.4291,-45.173,'Corrente'),\r\n"
					+ "(7,-6.7614,-43.0033,'Floriano'),\r\n" + "(7,-9.8751,-45.3458,'Gilbuês'),\r\n"
					+ "(7,-6.9741,-42.1468,'Oeiras'),\r\n" + "(7,-3.0866,-41.7831,'Parnaíba'),\r\n"
					+ "(7,-8.1322,-41.1429,'Paulistana'),\r\n" + "(7,-7.071,-41.404,'Picos'),\r\n"
					+ "(7,-4.276,-41.7945,'Piripiri'),\r\n" + "(7,-8.3649,-42.2503,'São João do Piauí'),\r\n"
					+ "(7,-5.911,-42.7187,'São Pedro do Piauí'),\r\n"
					+ "(7,-9.0332,-42.7011,'São Raimundo Nonato'),\r\n" + "(7,-5.0347,-42.8013,'Teresina'),\r\n"
					+ "(7,-7.4414,-44.345,'Uruçuí'),\r\n" + "(7,-6.3992,-41.7399,'Valênça do Piauí'),\r\n"
					+ "(8,-3.121,-40.0872,'Acaraú'),\r\n" + "(8,-7.3009,-39.2711,'Barbalha'),\r\n"
					+ "(8,-7.0777,-40.3626,'Campos Sales'),\r\n" + "(8,-5.1866,-40.6721,'Crateús'),\r\n"
					...
					+ "(11,-22.9519,-46.5305,'Bragança Paulista'),\r\n"
					+ "(11,-22.689,-45.0054,'Cachoeira Paulista'),\r\n"
					+ "(11,-22.7502,-45.6038,'Campos do jordão'),\r\n" + "(11,-21.7805,-47.0752,'Casa Branca'),\r\n"
					...
					+ "(11,-21.0856,-49.9203,'José Bonifácio'),\r\n" + "(11,-21.666,-49.7348,'Lins'),\r\n"
					+ "(11,-22.2352,-49.9651,'Marília'),\r\n" + "(11,-22.949,-49.8945,'Ourinhos'),\r\n"
					+ "(11,-22.7031,-47.6233,'Piracicaba'),\r\n" + "(11,-21.3384,-48.114,'Pradópolis'),\r\n"
					+ "(11,-22.1198,-51.4086,'Presidente Prudente'),\r\n" + "(11,-22.3728,-50.9747,'Rancharia'),\r\n"
					+ "(11,-24.5331,-47.8641,'Registro'),\r\n" + "(11,-21.9803,-47.8839,'São Carlos'),\r\n"
					+ "(11,-23.2283,-45.417,'São Luis do Paraitinga'),\r\n"
					+ "(11,-23.852,-48.1648,'São Miguel Arcanjo'),\r\n"
					+ "(11,-23.4962,-46.62,'São Paulo - Mirante do Santana'),\r\n"
					+ "(11,-23.7244,-46.6775,'São Paulo - Interlagos'),\r\n"
					+ "(11,-23.8107,-45.4025,'São Sebastião'),\r\n" + "(11,-21.461,-47.5795,'São Simão'),\r\n"
					+ "(11,-23.426,-47.5855,'Sorocaba'),\r\n" + "(11,-23.0416,-45.5208,'Taubaté'),\r\n"
					+ "(11,-21.9272,-50.4902,'Tupã'),\r\n" + "(11,-21.3191,-50.9301,'Valparaiso'),\r\n"
					+ "(11,-20.4032,-49.966,'Votuporanga'),\r\n" + "(12,-5.6265,-37.8149,'Apodi'),\r\n"
					+ "(12,-6.4674,-37.0849,'Caicó'),\r\n" + "(12,-5.1599,-35.4876,'Calcanhar'),\r\n"
					+ "(12,-5.5348,-36.8723,'Ipanguaçu'),\r\n" + "(12,-5.151,-36.5731,'Macau'),\r\n"
					+ "(12,-4.904,-37.3669,'Mossoró'),\r\n" + "(12,-5.8371,-35.2079,'Natal'),\r\n"
					...
					+ "(13,-7.1654,-34.8156,'João Pessoa'),\r\n" + "(13,-7.8944,-37.1247,'Monteiro'),\r\n"
					+ "(13,-7.0798,-37.2728,'Patos'),\r\n" + "(13,-6.8357,-38.3115,'São Gonçalo'),\r\n"
					+ "(14,-8.4335,-37.0554,'Arco Verde'),\r\n" + "(14,-8.504,-39.3152,'Cabrobó'),\r\n"
					...
					+ "(16,-9.5511,-35.7701,'Maceió'),\r\n" + "(16,-9.4203,-36.6203,'Palmeiras dos Índios'),\r\n"
					+ "(16,-9.7492,-37.4307,'Pão de Açucar'),\r\n" + "(16,-9.6222,-37.7671,'Piranhas'),\r\n"
					+ "(16,-9.2874,-35.5658,'São Luis do Quitunde'),\r\n" + "(17,-7.2054,-59.8885,'Apuí'),\r\n"
					+ "(17,-3.5833,-59.1294,'Autazes'),\r\n" + "(17,-0.9872,-62.9242,'Barcelos'),\r\n"
					+ "(17,-8.7768,-67.3325,'Boca do Acre'),\r\n" + "(17,-4.0974,-63.1453,'Coari'),\r\n"
					+ "(17,-6.6503,-69.8686,'Eirunepé'),\r\n" + "(17,-7.5525,-63.0713,'Humaitá'),\r\n"
					+ "(17,-3.1333,-58.4827,'Itacoatiara'),\r\n" + "(17,-7.2606,-64.7885,'Lábrea'),\r\n"
					+ "(17,-3.2946,-60.6284,'Manacapuru'),\r\n" + "(17,-3.1036,-60.0154,'Manaus'),\r\n"
					+ "(17,-5.7885,-61.2882,'Manicore'),\r\n" + "(17,-3.399,-57.6737,'Maués'),\r\n"
					+ "(17,-5.1411,-60.3805,'Novo Aripuanã'),\r\n" + "(17,-2.6391,-56.7561,'Parintins'),\r\n"
					+ "(17,-2.0565,-60.0257,'Presidente Figueiredo'),\r\n" + "(17,-2.6336,-59.6005,'Rio Urubu'),\r\n"
					+ "(17,-0.1252,-67.0612,'São gabriel da Cachoeira'),\r\n" + "(17,-2.5347,-57.758,'Urucará'),\r\n"
					+ "(18,-0.5678,-50.8235,'Itaubal'),\r\n" + "(18,-0.035,-51.0887,'Macapá'),\r\n"
					...
					+ "(19,-12.193,-43.2134,'Ibotirama'),\r\n" + "(19,-14.6588,-39.1814,'Ilhéus'),\r\n"
					+ "(19,-14.1713,-39.6925,'Ipiaú'),\r\n" + "(19,-11.3289,-41.8645,'Irecê'),\r\n"
					+ "(19,-12.524,-40.2997,'Itaberaba'),\r\n" + "(19,-17.4366,-39.5508,'Itamaraju'),\r\n"
					+ "(19,-15.2446,-40.2295,'Itapetinga'),\r\n" + "(19,-13.5278,-40.1197,'Itiruçu'),\r\n"
					+ "(19,-11.2051,-40.4649,'Jacobina'),\r\n" + "(19,-10.0807,-38.3459,'Jeremoabo'),\r\n"
					+ "(19,-12.5578,-41.3888,'Lençóis'),\r\n" + "(19,-12.1523,-45.8297,'Luis Eduardo Magalhães'),\r\n"
					+ "(19,-12.1316,-40.3542,'Macajuba'),\r\n" + "(19,-13.9069,-38.9722,'Maraú'),\r\n"
					+ "(19,-13.1556,-41.7741,'Piatã'),\r\n" + "(19,-10.0183,-42.5002,'Pilão Arcado'),\r\n"
					...
					+ "(19,-12.8082,-38.4959,'Salvador-Est. Rádio Marinha'),\r\n"
					+ "(19,-11.0027,-44.5249,'Santa Rita de Cássia'),\r\n"
					+ "(19,-10.443,-40.1482,'Senhor do Bonfim'),\r\n" + "(19,-11.6645,-39.0229,'Serrinha'),\r\n"
					+ "(19,-9.8336,-39.4956,'Uauá'),\r\n" + "(19,-15.2802,-39.0912,'Uma'),\r\n"
					+ "(19,-13.3436,-39.1266,'Valença'),\r\n" + "(19,-14.8864,-40.8013,'Vitória da Conquista'),\r\n"
					+ "(20,-20.1041,-41.1068,'Afonso Claudio'),\r\n" + "(20,-20.7504,-41.4888,'Alegre'),\r\n"
					+ "(20,-20.6365,-40.7418,'Alfredo Chaves'),\r\n" + "(20,-18.2915,-40.7364,'Ecoporanga'),\r\n"
					+ "(20,-19.3569,-40.0686,'Linhares'),\r\n" + "(20,-19.4071,-40.5398,'Marilândia'),\r\n"
					+ "(20,-18.6952,-40.3905,'Nova Venécia'),\r\n" + "(20,-21.1008,-41.0393,'Presidente Kennedy'),\r\n"
					+ "(20,-19.9883,-40.5795,'Santa Teresa'),\r\n" + "(20,-18.6761,-39.864,'São Mateus'),\r\n"
					+ "(20,-20.3854,-41.1899,'Venda Nova do Imigrante'),\r\n" + "(20,-20.467,-40.404,'Vila velha'),\r\n"
					+ "(20,-20.271,-40.306,'Vitória-Goiabeiras'),\r\n" + "(21,-15.7515,-41.4577,'Águas Vermelhas'),\r\n"
					+ "(21,-19.5327,-41.0908,'Aimorés'),\r\n" + "(21,-16.1667,-40.6877,'Almenara'),\r\n"
					+ "(21,-16.8488,-42.0353,'Araçuai'),\r\n" + "(21,-19.6056,-46.9496,'Araxá'),\r\n"
					+ "(21,-20.0311,-46.0088,'Bambuí'),\r\n" + "(21,-21.2283,-43.7677,'Barbacema'),\r\n"
					...
					+ "(21,-15.3001,-45.6174,'Chapada Gaúcha'),\r\n"
					+ "(21,-19.9858,-48.1515,'Conceição das Alagoas'),\r\n"
					+ "(21,-21.5467,-43.261,'Coronel Pacheco'),\r\n" + "(21,-18.7477,-44.4537,'Curvelo'),\r\n"
					+ "(21,-18.231,-43.6482,'Diamantina'),\r\n" + "(21,-20.1732,-44.8749,'Divinópolis'),\r\n"
					+ "(21,-19.4819,-45.5939,'Dores do Indaiá'),\r\n" + "(21,-19.8853,-44.4168,'Florestal'),\r\n"
					+ "(21,-20.4549,-45.4538,'Formiga'),\r\n" + "(21,-18.8303,-41.977,'Governador Valadares'),\r\n"
					+ "(21,-18.7868,-42.9429,'Guanhães'),\r\n" + "(21,-17.5613,-47.1992,'Guarda Mor'),\r\n"
					+ "(21,-20.0314,-44.0112,'Ibirité'),\r\n" + "(21,-16.5756,-41.4855,'Itaobim'),\r\n"
					+ "(21,-18.9529,-49.525,'Ituiutaba'),\r\n" + "(21,-15.8028,-43.297,'Janaúba'),\r\n"
					+ "(21,-15.448,-44.3663,'Januária'),\r\n" + "(21,-17.7847,-46.1193,'João Pinheiro'),\r\n"
					+ "(21,-21.7699,-43.3643,'Juiz de Fora'),\r\n" + "(21,-21.6807,-45.9443,'Machado'),\r\n"
					+ "(21,-20.2633,-42.1828,'Manhuaçu'),\r\n" + "(21,-18.7806,-40.9865,'Mantena'),\r\n"
					+ "(21,-22.3145,-45.373,'Maria da Fé'),\r\n" + "(21,-15.0859,-44.016,'Moçambinho'),\r\n"
					+ "(21,-14.4082,-44.4041,'Montalvânia'),\r\n" + "(21,-16.6863,-43.8437,'Montes Claros'),\r\n"
					+ "(21,-22.8616,-46.0433,'Monte Verde'),\r\n" + "(21,-21.1048,-42.3759,'Muriaé'),\r\n"
					...
					+ "(21,-18.9966,-46.9859,'Patrocínio'),\r\n" + "(21,-17.258,-44.8356,'Pirapora'),\r\n"
					+ "(21,-15.7231,-42.4357,'Rio Pardo de Minas'),\r\n" + "(21,-19.8752,-47.4341,'Sacramento'),\r\n"
					+ "(21,-16.1603,-42.3102,'Salinas'),\r\n" + "(21,-21.1065,-44.2509,'São João Del Rei'),\r\n"
					+ "(21,-16.3627,-45.1238,'São Romão'),\r\n"
					+ "(21,-20.9098,-47.1142,'São Sebastião do Paraíso'),\r\n"
					+ "(21,-17.7987,-40.2499,'Serra dos Aimorés'),\r\n" + "(21,-19.4552,-44.1733,'Sete Lagoas'),\r\n"
					+ "(21,-17.8928,-41.5154,'Teófilo Otoni'),\r\n" + "(21,-19.5738,-42.6224,'Timóteo'),\r\n"
					+ "(21,-18.2008,-45.4598,'Três Marias'),\r\n" + "(21,-19.71,-47.9618,'Uberaba'),\r\n"
					+ "(21,-18.917,-48.2556,'Uberlândia'),\r\n" + "(21,-16.5541,-46.8819,'Unaí'),\r\n"
					+ "(21,-21.5665,-45.4043,'Varginha'),\r\n" + "(21,-20.7626,-42.864,'Viçosa'),\r\n"
					+ "(22,-20.4444,-52.8758,'Água Clara'),\r\n" + "(22,-23.0025,-55.3293,'Amambaí'),\r\n"
					+ "(22,-22.148,-53.7637,'Angélica'),\r\n" + "(22,-20.4754,-55.784,'Aquidauana'),\r\n"
					+ "(22,-22.955,-62.626,'Aral Moreira'),\r\n" + "(22,-21.7521,-52.4712,'Bataguassu'),\r\n"
					+ "(22,-22.1015,-56.5407,'Bela Vista'),\r\n" + "(22,-21.2982,-52.0689,'Brasilândia'),\r\n"
					+ "(22,-22.657,-54.8193,'Caarapó'),\r\n" + "(22,-20.4471,-54.7226,'Campo Grande'),\r\n"
					+ "(22,-19.1224,-51.7207,'Cassilândia'),\r\n" + "(22,-18.8021,-52.6026,'Chapadão do Sul'),\r\n"
					+ "(22,-18.9966,-57.6375,'Corumbá'),\r\n" + "(22,-18.4926,-53.1712,'Costa Rica'),\r\n"
					+ "(22,-18.5121,-54.7361,'Coxim'),\r\n" + "(22,-22.1939,-54.9113,'Dourados'),\r\n"
					+ "(22,-23.6448,-54.5702,'Iguatemi'),\r\n" + "(22,-22.0928,-54.7988,'Itaporâ'),\r\n"
					+ "(22,-23.4495,-54.1818,'Itaquiraí'),\r\n" + "(22,-22.3004,-53.8228,'Invinhema'),\r\n"
					+ "(22,-21.4785,-56.1377,'Jardim'),\r\n" + "(22,-22.8572,-54.6056,'Jutí'),\r\n"
					+ "(22,-22.5753,-55.1603,'Laguna Carapã'),\r\n" + "(22,-21.609,-55.1775,'Maracaju'),\r\n"
					+ "(22,-20.3955,-56.4317,'Miranda'),\r\n" + "(22,-18.9888,-56.6228,'Nhumirim'),\r\n"
					+ "(22,-21.4509,-54.3419,'Nova Alvorada do Sul'),\r\n" + "(22,-19.6955,-51.1817,'Paranaíba'),\r\n"
					+ "(22,-18.0727,-54.5488,'Pedro Gomes'),\r\n" + "(22,-22.5524,-55.7163,'Ponta Porâ'),\r\n"
					...
					+ "(22,-19.4203,-54.553,'São Gabriel do Oeste'),\r\n" + "(22,-20.3514,-51.4302,'Selvíria'),\r\n"
					+ "(22,-23.9668,-55.0242,'Sete Quedas'),\r\n" + "(22,-20.9816,-54.9718,'Sidrolândia'),\r\n"
					+ "(22,-17.6352,-54.7604,'Sonora'),\r\n" + "(22,-20.79,-51.7122,'Três Lagoas'),\r\n"
					+ "(23,-24.5708,-52.8002,'Campina da Lagoa'),\r\n" + "(23,-24.7869,-49.9992,'Castro'),\r\n"
					+ "(23,-23.3591,-52.9319,'Cidade Gaúcha'),\r\n" + "(23,-26.4172,-52.3487,'Clevelândia'),\r\n"
					+ "(23,-25.3224,-49.1577,'Colombo'),\r\n" + "(23,-25.4486,-49.2306,'Curitiba'),\r\n"
					+ "(23,-22.6393,-52.8901,'Diamante do Norte'),\r\n" + "(23,-25.699,-53.0952,'Dois Vizinhos'),\r\n"
					+ "(23,-25.6018,-54.483,'Foz do Iguaçú'),\r\n" + "(23,-26.3984,-51.3536,'General Carneiro'),\r\n"
					+ "(23,-24.1889,-53.049,'Goioerê'),\r\n" + "(23,-23.3903,-53.6359,'Icaraíma'),\r\n"
					+ "(23,-25.5678,-51.0779,'Inácio Martins'),\r\n" + "(23,-25.0107,-50.8538,'Ivaí'),\r\n"
					+ "(23,-23.7733,-50.1805,'Japira'),\r\n" + "(23,-23.5052,-49.9463,'Joaquim Távora'),\r\n"
					+ "(23,-25.3689,-52.3919,'Laranjeiras do Sul'),\r\n"
					+ "(23,-24.5333,-54.0192,'Marechal Cândido Rondon'),\r\n" + "(23,-23.4053,-51.9358,'Maringá'),\r\n"
					+ "(23,-25.5089,-48.8086,'Morretes'),\r\n" + "(23,-23.4152,-50.5777,'Nova Fátima'),\r\n"
					+ "(23,-24.4373,-51.963,'Nova Tebas'),\r\n" + "(23,-22.6582,-52.1345,'Paranapoema'),\r\n"
					+ "(23,-25.7218,-53.7479,'Planalto'),\r\n" + "(23,-25.8356,-50.3689,'São Mateus do Sul'),\r\n"
					...
					+ "(24,-22.0416,-41.0518,'Campos-São Tomé'),\r\n" + "(24,-21.9387,-42.6009,'Carmo'),\r\n"
					+ "(24,-22.5898,-43.2822,'Duque de Caxias-Xerém'),\r\n"
					+ "(24,-22.3739,-44.7031,'Itatiaia-Parque Nacional'),\r\n" + "(24,-22.3763,-41.812,'Macaé'),\r\n"
					+ "(24,-22.8673,-43.102,'Niterói'),\r\n" + "(24,-22.3348,-42.6769,'Nova Friburgo-Salinas'),\r\n"
					+ "(24,-23.2235,-44.7268,'Paraty'),\r\n" + "(24,-22.4648,-43.2915,'Petrópilis-Pico do Couto'),\r\n"
					+ "(24,-22.4509,-44.4447,'Resende'),\r\n" + "(24,-22.6535,-44.0409,'Rio Claro-Passa Três'),\r\n"
					+ "(24,-22.9882,-43.1904,'Rio de Janeiro-Forte de Copacabana'),\r\n"
					+ "(24,-22.9398,-43.4028,'Rio de Janeiro-Jacarepaguá'),\r\n"
					...
					+ "(24,-22.7578,-43.6848,'Seropédica-Ecologia Agrícola'),\r\n"
					+ "(24,-22.6459,-42.4157,'Sílvia Jardim'),\r\n"
					+ "(24,-22.4489,-42.9871,'Teresópolis-Parque Nacional'),\r\n"
					+ "(24,-22.0983,-43.2085,'Três Rios'),\r\n" + "(25,-29.709,-55.5254,'Alegrete'),\r\n"
					+ "(25,-31.3478,-54.0132,'Bagé'),\r\n" + "(25,-29.1645,-51.5342,'Bento Gonçalves'),\r\n"
					+ "(25,-30.5453,-53.467,'Caçapava do Sul'),\r\n" + "(25,-30.8079,-51.8342,'Camaquã'),\r\n"
					+ "(25,-29.0491,-50.1496,'Cambará do Sul'),\r\n" + "(25,-29.6742,-51.064,'Campo Bom'),\r\n"
					+ "(25,-29.3687,-50.8272,'Canela'),\r\n" + "(25,-31.4032,-52.7006,'Canguçu'),\r\n"
					+ "(25,-31.8025,-52.4072,'Capão do Leão-Pelotas'),\r\n" + "(25,-28.6034,-53.6735,'Cruz Alta'),\r\n"
					...
					+ "(25,-27.8904,-54.48,'Santa Rosa'),\r\n" + "(25,-33.7422,-53.3722,'Santa Vitória do Palmar'),\r\n"
					+ "(25,-29.1915,-54.8856,'Santiago'),\r\n" + "(25,-27.8543,-53.7911,'Santo Augusto'),\r\n"
					+ "(25,-28.65,-56.0162,'São Borja'),\r\n" + "(25,-30.3414,-54.3109,'São Gabriel'),\r\n"
					+ "(25,-28.7486,-50.0578,'São José dos Ausentes'),\r\n"
					+ "(25,-28.4171,-54.9624,'São Luiz Gonzaga'),\r\n"
					+ "(25,-29.7021,-54.6943,'São Vicente do Sul'),\r\n"
					+ "(25,-28.7048,-51.8707,'Serafina Corrêa'),\r\n" + "(25,-28.8592,-52.5423,'Soledade'),\r\n"
					+ "(25,-29.4503,-51.8242,'Teutônia'),\r\n" + "(25,-29.3503,-49.7332,'Torres'),\r\n"
					+ "(25,-30.0102,-50.1358,'Tramandaí'),\r\n" + "(25,-29.0893,-53.8266,'Tupanciretã'),\r\n"
					+ "(25,-29.8398,-57.0818,'Uruguaiana'),\r\n" + "(25,-28.5136,-50.8827,'Vacaria'),\r\n"
					+ "(26,-28.9313,-49.4979,'Aranranguá'),\r\n" + "(26,-26.8191,-50.9855,'Caçador'),\r\n"
					+ "(26,-27.3838,-51.216,'Campos Novos'),\r\n" + "(26,-27.0853,-52.6357,'Chapecó'),\r\n"
					+ "(26,-27.2886,-50.6042,'Curitibanos'),\r\n" + "(26,-26.2865,-53.6331,'Dionísio Cerqueira'),\r\n"
					+ "(26,-27.6025,-48.62,'Florianópolis-São José'),\r\n" + "(26,-26.9137,-49.2679,'Indaial'),\r\n"
					+ "(26,-26.9509,-48.762,'Itajaí'),\r\n" + "(26,-26.0813,-48.6417,'Itapoá'),\r\n"
					+ "(26,-27.4184,-49.6468,'Ituporanga'),\r\n" + "(26,-27.1692,-51.5589,'Joaçaba'),\r\n"
					...
					+ "(26,-28.2756,-49.9346,'São Joaquim'),\r\n" + "(26,-26.7766,-53.5045,'São Miguel do Oeste'),\r\n"
					+ "(26,-28.5325,-49.3152,'Urussanga'),\r\n" + "(26,-26.9386,-52.398,'Xanxarê')" + ""); //
