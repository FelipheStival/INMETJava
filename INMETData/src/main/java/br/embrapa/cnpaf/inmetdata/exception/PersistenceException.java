 ...
 * <br>
 * <p>
 * <b> Error occurred during the persistence operations of a system entity.</b>
 * </p>
 * 
 ...
 * 
 */
public class PersistenceException extends GenericException {
	 ...
	 */
	public PersistenceException(GenericException exception) {
		super(exception);
	}
	 ...
	 */
	public PersistenceException(String message, String ipAddress, MessageEnum error, String className, String methodName, String exceptionMessage, List<GenericException> causes) {
