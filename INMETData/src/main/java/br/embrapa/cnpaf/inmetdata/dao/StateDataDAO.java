 ...
 *
 */
public class StateDataDAO extends GenericDAO<StateDataDAO, StateEntily> {

	private static StateDataDAO instance;
	 ...
	 *                              DAO.
	 */
	private StateDataDAO(String logClientName, Level logLevel) throws PersistenceException {
	 ...
	 *                              DAO.
	 */
	public static synchronized StateDataDAO getInstanceOf(String logClientName, Level logLevel)
			throws PersistenceException {
		if (StateDataDAO.instance == null) {
			StateDataDAO.instance = new StateDataDAO(logClientName, logLevel);
		}
		return StateDataDAO.instance;
	}
	 ...
	 *                              DAO instance.
	 */
	public static synchronized StateDataDAO getInstanceOf() throws PersistenceException {
		return StateDataDAO.getInstanceOf(StateDataDAO.class.getSimpleName(), LOG_DEFAULT_LEVEL);
	}

	@Override
	public StateDataDAO save(StateEntily entity) throws PersistenceException {
	...
	@Override
	public StateDataDAO remove(Long id) throws PersistenceException {
...
//			this.removeStationRelationship(station.getId());
	...
	@Override
	protected StateDataDAO init() throws PersistenceException {
	 ...
	 *                              relationship.
	 */
	private StateDataDAO saveStationRelationship(InmetStationEntity entity) throws PersistenceException {
		if (entity != null) {
	 ...
	 * @return Returns the instance of DAO.
	 */
	private StateDataDAO removeStationRelationship(Long entityId) {
		try {
